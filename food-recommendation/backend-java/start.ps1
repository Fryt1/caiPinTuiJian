...
Write-Host "   PowerShell启动脚本 (UTF-8编码)" -ForegroundColor Green
Write-Host "==========================================" -ForegroundColor Green
Write-Host ""
...
# 启动Spring Boot应用
mvn spring-boot:run '-Dspring-boot.run.jvmArguments=-Dfile.encoding=UTF-8 -Dconsole.encoding=UTF-8 -Duser.timezone=Asia/Shanghai -Duser.language=zh -Duser.country=CN'
